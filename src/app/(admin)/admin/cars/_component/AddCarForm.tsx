...
type CarStatusUnion = typeof carStatuses[number];
...
export const AddCarForm = () => {
  ...
  useEffect(() => {
    const res = addCarResult as { success?: boolean } | undefined;
    if (res?.success) {
  ...
  useEffect(() => {
    if (processImageError) {
      const msg = (processImageError as { message?: string })?.message || "Failed to upload car";
      toast.error(msg);
    }
  }, [processImageError]);
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      onValueChange={(value) => setValue("status", value as CarStatusUnion)}
