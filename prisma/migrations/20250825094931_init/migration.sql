...
CREATE TABLE "public"."DealershipInfo" (
    ...
    "address" TEXT NOT NULL DEFAULT 'Car Street, Autovill',
...
-- CreateTable
CREATE TABLE "public"."UserSavedCars" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "carId" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "WorkingHour_dealershipId_dayOfWeek_idx" ON "public"."WorkingHour"("dealershipId", "dayOfWeek");
...
-- CreateIndex
CREATE INDEX "UserSavedCars_userId_idx" ON "public"."UserSavedCars"("userId");

-- CreateIndex
CREATE INDEX "UserSavedCars_carId_idx" ON "public"."UserSavedCars"("carId");

-- CreateIndex
CREATE UNIQUE INDEX "UserSavedCars_userId_carId_key" ON "public"."UserSavedCars"("userId", "carId");

-- AddForeignKey
ALTER TABLE "public"."TestDriveBooking" ADD CONSTRAINT "TestDriveBooking_carId_fkey" FOREIGN KEY ("carId") REFERENCES "public"."Car"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."TestDriveBooking" ADD CONSTRAINT "TestDriveBooking_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."UserSavedCars" ADD CONSTRAINT "UserSavedCars_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."UserSavedCars" ADD CONSTRAINT "UserSavedCars_carId_fkey" FOREIGN KEY ("carId") REFERENCES "public"."Car"("id") ON DELETE CASCADE ON UPDATE CASCADE;
